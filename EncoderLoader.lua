...
local function isWhitelisted(userId)
    local decodedIds = Base64Decode(encodedWhitelistedIds)  -- Decode the Base64 string
    local ids = HttpService:JSONDecode("[" .. decodedIds .. "]")  -- Convert the decoded string into a table of IDs
